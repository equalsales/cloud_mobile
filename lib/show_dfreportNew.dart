...
class _ShowdfReportNewPageState extends State<ShowdfReportNew> {
  ...
  Future<bool> loadreportsetting() async {
    ...
    uri ='https://www.cloud.equalsoftlink.com/api/api_reportsettinglist?dbname=$clientid&cno=$companyid&alias='+ccalias+cRptCaption+'Setting';
        ...
        child: Padding(
          ...
          child: ListTile(
            ...
            title: Text(widget.xcompanyname +
                ...
                widget.xfend +
                ")"),
            // subtitle: Text(widget.xcompanyname),
            leading: Icon(
                      ...
                      Row(
                        children: [
                          for (int j = 0; j < colInfo.length; j++) ...[
                            if (colInfo[j]['visible'].toString() == 'true') ...[
                              if (this
                                ...
                                Container(
                                  margin: EdgeInsets.all(6.0),
                                  padding: EdgeInsets.all(3.0),
                                  width: double.parse(colInfo[j]['width']) * 10,
                                  decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(8),
                                      color: Colors.white),
                                  child: Text("0.00",
