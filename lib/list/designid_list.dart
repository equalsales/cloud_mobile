...
class designid_list extends StatefulWidget {
  ...
  @override
  designid_listState createState() => designid_listState();
}

class designid_listState extends State<designid_list> {
  List _designlist = [];
  List _orgdesignlist = [];
        ...
        children: <Widget>[
          ...
          Expanded(
            ...
            itemBuilder: (context, index) {
              int id = this._designlist[index]['id'];
              ...
              return ListTile(
                ...
                onTap: () {
                  _designIdSelected.add(_designlist[index]['id'].toString());
                  _designIdSelected.add(_designlist[index]['design']);
                  if (_selected[index]) {
                    _designSelected.remove(id);
                    _designSelected.remove(design);
                  } else {
                     _designSelected.add(id);
