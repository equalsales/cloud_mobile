...
class branchid_list extends StatefulWidget {
  ...
  @override
  BranchListIdState createState() => BranchListIdState();
}

class BranchListIdState extends State<branchid_list> {
  List _branchlist = [];
  List _orgbranchlist = [];
  List _branchSelected = [];
  List _branchIdSelected = [];
  List<bool> _selected = [];
  String query = '';
        ...
        children: <Widget>[
          ...
          ElevatedButton(
            onPressed: () {
              ...
              Navigator.pop(context, _branchSelected);
            },
            child: Text('Select'),
          ),
          Expanded(
            ...
            itemBuilder: (context, index) {
              ...
              return ListTile(
                ...
                onTap: () {
                  _branchIdSelected.add(_branchlist[index]['id'].toString());
                  _branchIdSelected.add(_branchlist[index]['branch']);
                  if (_selected[index]) {
                    _branchSelected.remove(id);
                    _branchSelected.remove(account);
                  } else {
                    _branchSelected.add(id);
