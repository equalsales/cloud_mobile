...
import 'package:cloud_mobile/module/looms/beamjobissue/add_loombeamjobissue.dart';

class LoomBeamJobIssueList extends StatefulWidget {
  var xcompanyid;
  var xcompanyname;
  var xfbeg;
  var xfend;

  LoomBeamJobIssueList({Key? mykey, companyid, companyname, fbeg, fend})
      : super(key: mykey) {
  ...
  @override
  _LoomBeamJobIssueListPageState createState() =>
      _LoomBeamJobIssueListPageState();
}

class _LoomBeamJobIssueListPageState extends State<LoomBeamJobIssueList> {
    ...
    return Scaffold(
      ...
      body: Center(
        ...
        itemBuilder: (context, index) {
          ...
          String expecdelvdt = this._companydetails[index]['expecdelvdt'].toString();
