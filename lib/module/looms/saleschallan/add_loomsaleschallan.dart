...
import 'add_loomsaleschallandet.dart';
import '../../../list/city_list.dart';
import '../../../list/party_list.dart';
import '../../../common/bottombar.dart';
import '../../../list/branch_list.dart';
import '../../../list/salesman_list.dart';
...
class _LoomSalesChallanAddState extends State<LoomSalesChallanAdd> {
  ...
  final _branch = TextEditingController(),
      _packingtype = TextEditingController(),
      _packingsrchr = TextEditingController(),
      _packingserial = TextEditingController(),
      _serial = TextEditingController(),
      _srchr = TextEditingController(),
      _book = TextEditingController(),
      _bookno = TextEditingController(),
      _date = TextEditingController(),
      _party = TextEditingController(),
      _agent = TextEditingController(),
      _delparty = TextEditingController(),
      _haste = TextEditingController(),
      _salesman = TextEditingController(),
      _transport = TextEditingController(),
      _remarks = TextEditingController(),
      _parcel = TextEditingController(),
      _duedays = TextEditingController(),
      _station = TextEditingController(),
      _tottaka = TextEditingController(),
      _totmtrs = TextEditingController(),
      _branchid = TextEditingController(),
      _gstregno = TextEditingController();
  ...
  void initState() {
    ...
    if (sachinUsers.contains(globals.username.toUpperCase())) {
      hasteenabled = true;
    } else {
      // hasteenabled = false;
    }
                ...
                if (crlimit < clobl) {
                  ...
                  if (_formKey.currentState!.validate()) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                          content: const Text('Data saving progressing...')),
                    );
                    _handleSaveData();
                  }
                }
  ...
  Future<bool> loadDetData() async {
    ...
    print("jsonData[iCtr]['ordno'].toString() => ${jsonData[0]['orderno']}");
    ...
    if (sachinUsers.contains(globals.username.toUpperCase())) {
      ...
      if (jsonCode == '500') {
        ...
        if (globals.username == 'SACHIN') {
          // if (globals.username == 'SACHIN' || globals.username == 'SALE') {
          // if (id == 0) {
  ...
  List<DataRow> _createRows() {
    ...
    for (int iCtr = 0; iCtr < ItemDetails.length; iCtr++) {
      ...
      _datarow.add(DataRow(cells: [
        ...
        DataCell(Text(
            ItemDetails[iCtr]['takachr'] + '-' + ItemDetails[iCtr]['takano'])),
