...
import 'package:cloud_mobile/module/looms/yarnjobissue/add_loomyarnjobissue.dart';

class LoomYarnJobIssueList extends StatefulWidget {
  var xcompanyid;
  var xcompanyname;
  var xfbeg;
  var xfend;

  LoomYarnJobIssueList({Key? mykey, companyid, companyname, fbeg, fend})
      : super(key: mykey) {
  ...
  @override
  _LoomYarnJobIssueListPageState createState() =>
      _LoomYarnJobIssueListPageState();
}
