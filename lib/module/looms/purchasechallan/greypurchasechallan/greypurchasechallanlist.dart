...
import 'package:cloud_mobile/module/looms/purchasechallan/greypurchasechallan/add_greypurchasechallan.dart';
...
class GreyPurchaseChallanList extends StatefulWidget {
  var xcompanyid;
  var xcompanyname;
  var xfbeg;
  var xfend;

  GreyPurchaseChallanList({Key? mykey, companyid, companyname, fbeg, fend})
      : super(key: mykey) {
  ...
  @override
  _GreyPurchaseChallanListPageState createState() => _GreyPurchaseChallanListPageState();
}

class _GreyPurchaseChallanListPageState extends State<GreyPurchaseChallanList> {
  ...
  Future<bool> loaddetails() async {
    ...
    String uri = '${globals.cdomain}/api/api_getgreyurchallanlist?dbname=' +
            db +
            '&cno=' +
            cno +
            '&startdate=' +
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Grey Purchase Challan  List',
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () => {
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (_) => GreyPurchaseChallanAdd(
                        companyid: widget.xcompanyid,
                        companyname: widget.xcompanyname,
                        fbeg: widget.xfbeg,
                        fend: widget.xfend,
      ...
      body: Center(
        ...
        itemBuilder: (context, index) {
          ...
          String agent = this._companydetails[index]['agent'].toString();
...
void execDelete(BuildContext context, int index, int id, String name) {
  showDialog<String>(
    ...
    builder: (BuildContext context) => AlertDialog(
      title: const Text('Delete Grey Purchase Challan Entry ??'),
