...
class MachinecardList extends StatefulWidget {
  var xcompanyid;
  var xcompanyname;
  var xfbeg;
  var xfend;

  MachinecardList({Key? mykey, companyid, companyname, fbeg, fend})
      : super(key: mykey) {
  ...
  @override
  _MachinecardListPageState createState() =>
      _MachinecardListPageState();
}

class _MachinecardListPageState extends State<MachinecardList> {
...
void execDelete(BuildContext context, int index, int id, String name) {
  showDialog<String>(
    ...
    builder: (BuildContext context) => AlertDialog(
      title: const Text('Delete Machine Card ??'),
