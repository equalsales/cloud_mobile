...
import 'package:cloud_mobile/module/looms/jobreceive/beamjobworkreceive/add_beamjobworkreceive.dart';
...
class BeamJobworkReceiveList extends StatefulWidget {
  var xcompanyid;
  var xcompanyname;
  var xfbeg;
  var xfend;

  BeamJobworkReceiveList({Key? mykey, companyid, companyname, fbeg, fend})
      : super(key: mykey) {
  ...
  @override
  _BeamJobworkReceiveListPageState createState() => _BeamJobworkReceiveListPageState();
}

class _BeamJobworkReceiveListPageState extends State<BeamJobworkReceiveList> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Beam Jobwork Receive  List',
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () => {
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (_) => BeamJobworkReceiveAdd(
                        companyid: widget.xcompanyid,
                        companyname: widget.xcompanyname,
                        fbeg: widget.xfbeg,
                        fend: widget.xfend,
...
void execDelete(BuildContext context, int index, int id, String name) {
  showDialog<String>(
    ...
    builder: (BuildContext context) => AlertDialog(
      title: const Text('Delete Beam Jobwork Receive Entry ??'),
