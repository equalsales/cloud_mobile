...
class PurchaseBillAdd extends StatefulWidget {
  PurchaseBillAdd({Key? mykey, companyid, companyname, fbeg, fend, id})
      : super(key: mykey) {
  ...
  @override
  _PurchaseBillAddState createState() => _PurchaseBillAddState();
}

class _PurchaseBillAddState extends State<PurchaseBillAdd> {
