...
class BankMasterList extends StatefulWidget {
  var xcompanyid;
  var xcompanyname;
  var xfbeg;
  var xfend;

  BankMasterList({Key? mykey, companyid, companyname, fbeg, fend})
      : super(key: mykey) {
  ...
  @override
  _BankMasterListPageState createState() => _BankMasterListPageState();
}
...
class _BankMasterListPageState extends State<BankMasterList> {
  ...
  Future<bool> loaddetails() async {
    ...
    String uri = '';
    uri =
        "${globals.cdomain2}/api/api_banklist?dbname=$clientid&cno=$companyid";
  ...
  void onDel(id) {
    ...
    showDialog<void>(
      ...
      builder: (BuildContext context) {
        //saveData();
        return AlertDialog(
          title: const Text('Do You Want To Delete Bank Master !!??'),
          content: Container(
            height: 10,
            child: Column(
  ...
  Widget build(BuildContext context) {
    return ModuleVIew(
      ...
      Title: 'List Of Bank',
      DataFormat: 'Party : #party#  AccType : #acctype#  UPIID : #upiid#  ',
      onAdd: onAdd,
      onBack: onBack,
      onPDF: onPDF,
      onDel: onDel,
