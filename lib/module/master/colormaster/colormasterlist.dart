...
Future<bool> loaddetails() async {
    ...
    String uri = '';
    uri =
        "https://www.cloud.equalsoftlink.com/api/api_colorlist?dbname=$clientid&cno=$companyid";
  ...
  Future<bool> DeleteData(id) async {
    ...
    String uri = '';
    uri =
        "https://www.cloud.equalsoftlink.com/api/api_masterdeletevld?dbname=$clientid&cno=$companyid&cfldkey=colormst&id=$id";
    var response = await http.get(Uri.parse(uri));
    print(uri);
    var jsonData = jsonDecode(response.body);
    jsonData['Code'];
